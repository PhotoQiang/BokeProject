...
public class TiaoServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String messageContent=request.getParameter("messagecount");
		...
		response.sendRedirect("/BokeProject/message/replyMessage.jsp");
